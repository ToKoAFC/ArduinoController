...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.BluetoothLE.Internals.GattCallbacks, Plugin.BluetoothLE, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GattCallbacks.class, __md_methods);
	}


	public GattCallbacks () throws java.lang.Throwable
	{
		super ();
		if (getClass () == GattCallbacks.class)
			mono.android.TypeManager.Activate ("Plugin.BluetoothLE.Internals.GattCallbacks, Plugin.BluetoothLE, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
