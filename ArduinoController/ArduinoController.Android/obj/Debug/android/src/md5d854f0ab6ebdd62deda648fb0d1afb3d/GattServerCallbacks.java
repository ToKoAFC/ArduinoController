...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.BluetoothLE.Server.Internals.GattServerCallbacks, Plugin.BluetoothLE, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GattServerCallbacks.class, __md_methods);
	}


	public GattServerCallbacks () throws java.lang.Throwable
	{
		super ();
		if (getClass () == GattServerCallbacks.class)
			mono.android.TypeManager.Activate ("Plugin.BluetoothLE.Server.Internals.GattServerCallbacks, Plugin.BluetoothLE, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
