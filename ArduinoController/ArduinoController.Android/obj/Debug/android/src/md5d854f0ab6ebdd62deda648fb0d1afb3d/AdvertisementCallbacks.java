package md5d854f0ab6ebdd62deda648fb0d1afb3d;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.BluetoothLE.Server.Internals.AdvertisementCallbacks, Plugin.BluetoothLE, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AdvertisementCallbacks.class, __md_methods);
	}


	public AdvertisementCallbacks () throws java.lang.Throwable
	{
		super ();
		if (getClass () == AdvertisementCallbacks.class)
			mono.android.TypeManager.Activate ("Plugin.BluetoothLE.Server.Internals.AdvertisementCallbacks, Plugin.BluetoothLE, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
